...
const Footer = () => {
  ...
  return (
    <footer className="bg-card/80 backdrop-blur-md border-t border-primary/20 mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-muted-foreground max-w-xs">
              Discover the transformative power of your Saturn Return and navigate this important astrological transit with confidence.
            </p>
          </div>
